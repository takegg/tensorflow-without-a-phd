...
因此，让我们稍微提高patch大小，将convolutional层中的patch数量从4,8,12增加到6,12,24，然后在完全连接层上添加dropout。为什么不在convolutional层？其神经元复用相同权重，因此在一次训练迭代期间通过冻结一些权重来有效地工作，这样dropout不适用于它们。
